 ...
 *
 * ⚠️ ET AUCUNE FONCTION EDGE. Le back-office appelait `stripe-remboursement`
 * de serveur à serveur ; depuis les ordres financiers (P2a), un remboursement
 * se DEMANDE en base, et c'est `stripe-ordres`, réveillée par l'horloge, qui
 * parle à Stripe.
 */
